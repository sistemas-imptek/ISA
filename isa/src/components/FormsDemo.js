        ...
        return <div className="ui-g ui-fluid">
                    ...
                    <div className="ui-g form-group">
                        ...
                        <div className="ui-g-12">
                            <AutoComplete minLength={1} placeholder="Hint: type 'v' or 'f'" id="acAdvanced" size={30} dropdown={true} multiple={true}
                                          ...
                                          onChange={this.onBrandValueChange.bind(this)} onDropdownClick={this.handleDropdownClick.bind(this)}
            ...
            <div className="ui-g-12 ui-lg-6">
                ...
                <div className="card card-w-title">
                    ...
                    <div className="ui-g">
                        <div className="ui-g-12 ui-md-4">
                            <Checkbox value="Ultima" label="Ultima" onChange={this.onCheckboxChange} checked={this.state.checkboxValue.indexOf('Ultima')>-1?true:false} />
                        </div>
                        <div className="ui-g-12 ui-md-4">
                            <Checkbox value="Icarus" label="Icarus" onChange={this.onCheckboxChange} checked={this.state.checkboxValue.indexOf('Icarus')>-1?true:false} />
                        </div>
                        <div className="ui-g-12 ui-md-4">
                            <Checkbox value="Omega" label="Omega" onChange={this.onCheckboxChange} checked={this.state.checkboxValue.indexOf('Omega')>-1?true:false} />
                        </div>
                    </div>
                </div>
                ...
                <div className="card card-w-title">
                    <h1>RadioButtons</h1>
                    <div className="ui-g">
                        <div className="ui-g-12 ui-md-4"><RadioButton value="Ultima" label="Ultima" onChange={this.onRadioChange} checked={this.state.radioValue === "Ultima"} /></div>
                        <div className="ui-g-12 ui-md-4"><RadioButton value="Icarus" label="Icarus" onChange={this.onRadioChange} checked={this.state.radioValue === "Icarus"} /></div>
                        <div className="ui-g-12 ui-md-4"><RadioButton value="Omega" label="Omega" onChange={this.onRadioChange} checked={this.state.radioValue === "Omega"} /></div>
                    </div>
                </div>

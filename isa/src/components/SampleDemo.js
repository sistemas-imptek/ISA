                ...
                <div className="ui-g-12">
                    <div className="card card-w-title">
                        ...
                        <div className="ui-g form-group">
                            ...
                            <div className="ui-g-12 ui-md-4">
                                <div className="ui-g">
                                    <div className="ui-g-12"><Checkbox value="Ultima" label="Ultima" onChange={this.onCheckboxChange} checked={this.state.checkboxValue.indexOf('Ultima')>-1?true:false}/>
                                    </div>
                                    <div className="ui-g-12">
                            ...
                            <div className="ui-g-12 ui-md-4">
                                <div className="ui-g">
                                    <div className="ui-g-12"><RadioButton value="Ultima" label="Ultima" onChange={this.onRadioChange} checked={this.state.radioValue === "Ultima"}/></div>
                                    <div className="ui-g-12"><RadioButton value="Icarus" label="Icarus" onChange={this.onRadioChange} checked={this.state.radioValue === "Icarus"}/></div>
                                    <div className="ui-g-12"><RadioButton value="Omega" label="Omega" onChange={this.onRadioChange} checked={this.state.radioValue === "Omega"}/></div>
                                </div>
                            </div>
                            <div className="ui-g-12 ui-md-2">

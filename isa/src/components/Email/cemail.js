...
export class Email extends Component {
    ...
    render() {
        const footer = (
            <div>
                <Button label="Aceptar" icon="fa-check" className="ui-button-primary" onClick={() => this.sendEmail()} />
...
export function setParamsSendEmail(file, subject, msgEmail, listContacts) {
    that.changeChipsAdd(listContacts);

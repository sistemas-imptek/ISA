...
export class RTest extends Component {
    ...
    componentWillMount() {
        ...
        console.log(altura);
        console.log(ancho);
        /*  if (window.screen.availWidth <= 640) { window.parent.document.body.style.zoom = "62%"; }
         if (window.screen.availWidth == 800) { window.parent.document.body.style.zoom = "78%"; }
         if (window.screen.availWidth == 1024) { window.parent.document.body.style.zoom = "100%"; }
         if (window.screen.availWidth >= 1280) { window.parent.document.body.style.zoom = "80%"; } */
        providerNames = [];
    ...
    render() {
        ...
        return (
            <div className="ui-g">
                ...
                <Dialog visible={this.state.viewModal} header="Solicitud de Ensayo" style={{ width: '65vw', maxHeight: this.state.heightDialog }} footer={footerRequest} modal={true} closeOnEscape={true} onHide={() => this.setState({ viewModal: false })}>
                        ...
                        <Card style={{
                            ...
                            <div className="ui-grid ui-grid-responsive ui-fluid">
                                ...
                                <div className="ui-g-12 ui-lg-12" >
                                    <label className="ui-g-12 ui-lg-12" htmlFor="float-input"><span style={{ color: '#CB3234' }}>*</span>Objetivo</label>
                                    <div className="ui-g-12 ui-lg-4">
                                        ...
                                        <label htmlFor="cb1" style={{ paddingLeft: '8px' }} className="ui-checkbox-label">Ahorro de Costos</label>
                                    </div>
                                    <div className="ui-g-12 ui-lg-4">
                                ...
                                <div className="ui-g-12 ui-lg-12" >
                                    <label className="ui-g-12 ui-lg-12" htmlFor="float-input"> <span style={{ color: '#CB3234' }}>*</span>Tiempo de Entrega</label>
                                    <div className="ui-g-12 ui-lg-6">
                                        ...
                                        <label htmlFor="rb1" className="ui-radiobutton-label">Inmediato (Tiempo de desarrollo 5 días)</label>
                                    </div>
                                    <div className="ui-g-12 ui-lg-6">
                                        ...
                                        <label htmlFor="rb2" className="ui-radiobutton-label">Medio (Tiempo de desarrollo 15 días)</label>
                                    </div>
                                    <div className="ui-g-12 ui-lg-6">
                                        ...
                                        <label htmlFor="rb3" className="ui-radiobutton-label">Bajo (Tiempo de desarrollo 2 meses)</label>
                                    </div>
                                </div>
                                <div className='ui-g-12 ui-lg-12'>

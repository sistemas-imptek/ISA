...
export class RProcessTest extends Component {
    ...
    render() {
        ...
        const footerRequest = (
            <div>
                <Button label="Aceptar" icon="fa-check" className="ui-button-primary" onClick={this.saveTestRequest} />
                <Button label="Cancelar" icon="fa-times" className="ui-button-danger" onClick={() => this.setState({ viewModal: false, checked: false,
            objectives: [],
            otroMotivos: null,
            descriptionMaterialLP: [],
            productToGetting: null,
        ...
        return (
            <div className="ui-g">
                ...
                <Dialog visible={this.state.viewModal} header="Solicitud de Pruebas de Proceso DDP-04" style={{ width: '65vw', maxHeight: this.state.heightDialog }} footer={footerRequest} modal={true} closeOnEscape={true} onHide={() => this.setState({ viewModal: false })}>
                    <ScrollPanel style={{ width: '100%', height: this.state.heightScroll }} className="custom">
                        <Card style={{
                            ...
                            <div className="ui-grid ui-grid-responsive ui-fluid">
                                ...
                                <div className='ui-g-12 ui-lg-6' style={{ display: this.state.ddp04Single }}>
                                ...
                                <div className="ui-g-12 ui-lg-12" >
                                    <label className="ui-g-12 ui-lg-12" htmlFor="float-input"><span style={{ color: '#CB3234' }}>*</span>Motivo del Ensayo</label>
                                    <div className="ui-g-12 ui-lg-3">
                                        ...
                                        <label htmlFor="cb1" style={{ paddingLeft: '8px' }} className="ui-checkbox-label">Desarrollo Proveedores</label>
                                    </div>
                                    <div className="ui-g-12 ui-lg-3">
                                ...
                                <div className="ui-g-12 ui-lg-12" >
                                    <label className="ui-g-12 ui-lg-12" htmlFor="float-input"> <span style={{ color: '#CB3234' }}>*</span>Descripción del Material y Línea de Proceso de Prueba (Marque según corresponda)</label>
                                    <div className="ui-g-12 ui-lg-3">
                                ...
                                <div className='ui-g-12 ui-lg-12'>
                                    <span style={{ color: '#CB3234' }}>*</span><label htmlFor="float-input">Descripción del Producto que se quiere obtener</label>
                                ...
                                <div className='ui-g-12 ui-lg-12'>
                                    <span style={{ color: '#CB3234' }}>*</span><label htmlFor="float-input">Información sobre Variables de Proceso que deben ser controladas</label>
                                ...
                                <div className='ui-g-12 ui-lg-12'>
                                    <label htmlFor="float-input">Se requieren verificaciones adicionales u otras en especial</label>
                                ...
                                {/*  <label className="ui-g-12 ui-lg-12" htmlFor="float-input"> <span style={{ color: '#CB3234' }}>*</span>Se requiere adjuntar informe</label> */}
                                <div className="ui-g-12 ui-lg-12" >
                                    <div className="ui-g-12 ui-lg-4" >
                                        <span style={{ color: '#CB3234' }}>*</span><label htmlFor="float-input">Se requiere adjuntar informe</label>
                                        <div className="ui-g-12 ui-lg-12">
                                            <input type='file' onChange={this.onBasicUploadAuto} />
                                        </div>
                                    </div>
                                    <div className="ui-g-12 ui-lg-4" >
                                        <span style={{ color: '#CB3234' }}>*</span><label htmlFor="float-input">Detalle gráfico</label>
                                        <div className="ui-g-12 ui-lg-12">
                                            <input type='file' onChange={this.onBasicUploadAutoImageAdjunto} />
                                        </div>
                                    </div>
                                    <div className="ui-g-12 ui-lg-4" style={{ display: this.state.ddp04Single }}>
                                        <span style={{ color: '#CB3234' }}>*</span><label htmlFor="float-input">Otro</label>
                                        <div className="ui-g-12 ui-lg-12">

...
/* ===================== U T I L S   ======================== */
import { getDatenow, formattedDate, formattedStringtoDate, getDateWithNameMonth, getHourFromDate } from '../../utils/FormatDate';
...
var that;
export class WFlow extends Component {
        ...
        if (this.state.userLogin.employee.area.nameArea == 'COMPRAS') {
            if (rowData.state == 'En Proceso') {
                ...
                if (proc.listActionsProcess[1].listFileDocument.length != 0) {
                    ...
                    return (
                        <div>
                            <Button className='ui-button-secondary' icon='fa fa-file-pdf-o' label={nameButton} tooltip="Descargar" onClick={() => this.downloadFiles(proc.listActionsProcess[1].listFileDocument)} />
                        </div>
                    );
                ...
                if (rowData.files.length !== 0) {
                    ...
                    return (
                        <div>
                            <Button className='ui-button-secondary' icon='fa fa-file-pdf-o' label={nameButton} tooltip="Descargar" onClick={() => this.downloadFiles(rowData.files)} />
                        </div>
                    );
                }
            }
    ...
    */
    ...
    templateContentInformation(data) {
        ...
        return (
            <div className="ui-g" style={{ background: 'linear-gradient(to bottom, #e3f2fd, #f1f8e9)' }}>
                <div className="ui-g-12 ui-lg-12">
                    <spam style={{ fontWeight: 'bold' }}>SOLICITUD DE ENSAYO</spam>
                </div>
                <div className="ui-g-12 ui-lg-6">
                    <div className="ui-g-12 ui-lg-3">Fecha: </div>
                    <div className="ui-g-12 ui-lg-9" style={{ fontWeight: 'bold' }}>{data.testRequest.deliverDate}</div>

                    <div className="ui-g-12 ui-lg-3">Proveedor: </div>
                    <div className="ui-g-12 ui-lg-9" style={{ fontWeight: 'bold' }}>{data.testRequest.providerName}</div>

                    <div className="ui-g-12 ui-lg-3">Objetivo: </div>
                    <div className="ui-g-12 ui-lg-9" style={{ fontWeight: 'bold' }}>{data.testRequest.objective}</div>

                    <div className="ui-g-12 ui-lg-3">Linea de Aplicación: </div>
                    <div className="ui-g-12 ui-lg-9" style={{ fontWeight: 'bold' }}>{data.testRequest.aplicationLine}</div>

                </div>
                <div className="ui-g-12 ui-lg-6">
                    <div className="ui-g-12 ui-lg-3">Material: </div>
                    <div className="ui-g-12 ui-lg-9" style={{ fontWeight: 'bold' }}>{data.testRequest.materialDetail}</div>

                    <div className="ui-g-12 ui-lg-3">Cantidad: </div>
                    <div className="ui-g-12 ui-lg-9" style={{ fontWeight: 'bold' }}>{data.testRequest.quantity}<spam style={{ marginLeft: '3px' }}>{data.unit}</spam></div>

                    <div className="ui-g-12 ui-lg-3">Uso: </div>
                    <div className="ui-g-12 ui-lg-9" style={{ fontWeight: 'bold' }}>{data.testRequest.use}</div>

                    <div className="ui-g-12 ui-lg-3">Informe Final: </div>
                    <div className="ui-g-12 ui-lg-9" style={{ fontWeight: 'bold' }}>
    ...
    rowExpansionTemplate(data) {
        ...
        if (data.testRequest !== null) {
            return (
                <div className="ui-grid ui-grid-responsive ui-fluid" style={{ padding: '1em 1em 1em 1em', background: 'linear-gradient(to bottom, #e3f2fd, #f1f8e9)' }}>
                    <div className="ui-g-12 ui-lg-12">
                    ...
                    <div className="ui-g-12 ui-lg-6">
                        ...
                        <div className="ui-g-12 ui-lg-3">Cantidad: </div>
                        <div className="ui-g-12 ui-lg-9" style={{ fontWeight: 'bold' }}>{data.testRequest.quantity}<spam style={{ marginLeft: '3px' }}>{data.testRequest.unit}</spam></div>

                        <div className="ui-g-12 ui-lg-3">Uso: </div>
                        <div className="ui-g-12 ui-lg-9" style={{ fontWeight: 'bold' }}>{data.testRequest.use}</div>
                    </div>
                    <div className="ui-g-12 ui-lg-12" style={{ alignContent: 'right' }}>
                        <div className="ui-g-12 ui-lg-2" style={{ display: this.viewButtonValidate(data.state, "Validate") }}>
                            <Button label='Validar' icon='fa fa-check' className='ui-button-success' onClick={() => this.setState({ viewModalValidateDeliverMaterial: true, processToUpdate: data })} />
                        </div>
                        <div className="ui-g-12 ui-lg-2" style={{ display: this.viewButtonValidate(data.state, "Respond") }}>
                            <Button label='Responder' icon='fa fa-share-square-o' className='ui-button-success' onClick={() => this.setState({ displayRespond: '', displayTable: 'none', processToUpdate: data })} />
                        </div>
                        <div className="ui-g-12 ui-lg-2" style={{ display: this.viewButtonValidate(data.state, "SPP") }}>
                        ...
                        <div className="ui-g-12 ui-lg-2" style={{ display: this.viewButtonValidate(data.state, "SMP") }}>
                            <Button label='Solicitar MP' icon='fa fa-plus-circle' className='success-btn' onClick={() => this.requestOrderMP(data)} />
                        </div>
                        <div className="ui-g-12 ui-lg-2" style={{ display: this.viewButtonValidate(data.state, "VSMP") }}>
            ...
            return (
                <div className="ui-grid " style={{ padding: '1em 1em 1em 1em', background: 'linear-gradient(to bottom, #e3f2fd, #f1f8e9)' }}>
                    <div className="ui-g-12 ui-lg-12">
                        <div className="ui-g-12 ui-lg-6">
                    ...
                    <div className="ui-g-12 ui-lg-6">
                        <div className="ui-g-12 ui-lg-3">Fecha: </div>
                        <div className="ui-g-12 ui-lg-9" style={{ fontWeight: 'bold' }}>{data.processTestRequest.deliverDate}</div>

                        <div className="ui-g-12 ui-lg-3">Objetivo: </div>
                        <div className="ui-g-12 ui-lg-9" style={{ fontWeight: 'bold' }}>{data.processTestRequest.objective}</div>

                        <div className="ui-g-12 ui-lg-3">Descripción del Material: </div>
                        <div className="ui-g-12 ui-lg-9" style={{ fontWeight: 'bold' }}>{data.processTestRequest.materialLine}</div>

                        <div className="ui-g-12 ui-lg-3">Producto que se desea obtener: </div>
                        <div className="ui-g-12 ui-lg-9" style={{ fontWeight: 'bold' }}>{data.processTestRequest.productGetting}</div>

                    </div>
                    <div className="ui-g-12 ui-lg-6">
                        <div className="ui-g-12 ui-lg-3">Variables a considerar: </div>
                        <div className="ui-g-12 ui-lg-9" style={{ fontWeight: 'bold' }}>{data.processTestRequest.processVariables}</div>

                        <div className="ui-g-12 ui-lg-3">Verificaciones Adicionales: </div>
                        <div className="ui-g-12 ui-lg-9" style={{ fontWeight: 'bold' }}>{data.processTestRequest.additionVerification}</div>

                        <div className="ui-g-12 ui-lg-3">Detalle Gráfico: </div>
                        <div className="ui-g-12 ui-lg-9" ><Button icon='fa fa-picture-o' label='Ver' className='warning-btn' onClick={() => this.showImageProcessTestRequest(files)} /></div>
                    </div>
                    <div className="ui-g-12 ui-lg-12" style={{ alignContent: 'right' }}>

                        <div className="ui-g-12 ui-lg-2" style={{ display: this.viewButtonValidate(data.state, "Respond", "ProcessInTest") }}>
                            <Button label='Responder' icon='fa fa-share-square-o' className='ui-button-success' onClick={() => this.setState({ displayRespond: '', displayTable: 'none', processToUpdate: data, aproveAndShare: typeRespond })} />
                        </div>
                        <div className="ui-g-12 ui-lg-2" style={{ display: this.viewButtonValidate(data.state, "SPP") }}>
                            <Button label='Solicitud Pruebas en Proceso' icon='fa fa-hand-o-right' className='success-btn' onClick={() => this.startProcessTestRForm(data)} />
                        </div>
                        <div className="ui-g-12 ui-lg-2" style={{ display: this.viewButtonValidate(data.state, "AddFile", "ProcessInTest") }}>
                            <Button label='Subir Informe' icon='fa fa-upload' className='ui-button-success' onClick={() => this.setState({ displayRespond: '', displayTable: 'none', processToUpdate: data, addFileState: true })} />
                        </div>
                    </div>
            ...
            return (
                <div className="ui-grid " style={{ padding: '1em 1em 1em 1em', background: 'linear-gradient(to bottom, #e3f2fd, #f1f8e9)' }}>
                    ...
                    <div className="ui-g-12 ui-lg-12" style={{ padding: '0px' }}>
                        <div className='ui-g form-group ' style={{ justifyContent: 'center' }}>
                            ...
                            <div className="ui-g-12 ui-lg-4" style={{ display: filesRequestTest.length == 0 ? 'none' : '' }}>
    ...
    render() {
        ...
        const footerValidateDeliverMaterial = (
            <div>
                <Button label="Si" icon="fa-check" className="ui-button-primary" onClick={this.validationTestRequest} />
                <Button label="No" icon="fa-close" onClick={() => this.setState({ viewModalValidateDeliverMaterial: false })} className="ui-button-danger" />
            </div>
        );
        const footerViewModalSMP = (
            <div>
                <Button label="Si" icon="fa-check" className="ui-button-primary" onClick={this.availableSMPForDDP04} />
                <Button label="No" icon="fa-close" onClick={() => this.setState({ viewModalSMP: false, processToUpdate: null })} className="ui-button-danger" />
            </div>
        );
        return (
            <div className="ui-g">
                <Card className="ui-g-12 ui-lg-12" style={{ padding: '0px' }}>
                    <div className="ui-g-12 ui-lg-12" style={{ justifyContent: 'center', alignContent: 'center', padding: '0px' }}>
                ...
                <Card className="ui-g-12 ui-lg-12" style={{ padding: '0px', marginTop: '5px' }}>

                    <Toolbar>
                        <div className="ui-toolbar-group-right">
                            <Button className="secondary-btn" onClick={this.refreshDataWorkflow}>
                        ...
                        <div className="ui-toolbar-group-left">
                            <Button icon="fa-plus" label="Solicitud de Ensayos" style={{ display: this.state.viewNewRequestButton }} onClick={this.addComplaint} onClick={() => show_form()} />
                            <Button icon="fa-plus" label="Solicitud DDP04" style={{ display: this.state.userLogin.employee.area.nameArea == 'CALIDAD' ? '' : 'none' }} onClick={() => show_formRPP()} />
                        </div>
                    </Toolbar>
                ...
                <Card className="ui-g-12 ui-lg-12" style={{ padding: '0px', marginTop: '5px', display: this.state.displayRespond }}>
                    <div className="ui-grid ui-grid-responsive ui-fluid">
                        <div className='ui-g-12 ui-lg-12' style={{ background: '#e3f2fd' }}>
                            <label htmlFor="float-input" style={{ fontWeight: 'bolder' }}>ENVIAR RESPUESTA</label>
                        </div>

                        <div className='ui-g-12 ui-lg-3' style={{ display: this.state.approvView }}>
                        ...
                        <div className='ui-g-12 ui-lg-3' style={{ display: this.state.approvViewType }}>
                        ...
                        <div className='ui-g-12 ui-lg-2' style={{ display: this.state.viewStateDDP05 }}>
                            <label htmlFor="float-input">Informe Adicional</label>
                            <input type='file' onChange={this.onBasicUploadAutoResponseAditionalInform} />
                        </div>

                        <div className='ui-g-12 ui-lg-12'>
                            <div className='ui-g-12 ui-lg-10'></div>
                            <div className='ui-g-12 ui-lg-1'>
                                <Button className='ui-button-danger' label='Cancelar' icon='fa fa-chevron-circle-left' onClick={() => this.setState({ displayRespond: 'none', displayTable: '', addFileState: false, commentResponse: null, approveType: null, approve: null, aproveAndShare: false })} />
                            </div>
                            <div className='ui-g-12 ui-lg-1'>
                                <Button className='ui-button-success' label='Enviar' icon='fa fa-paper-plane-o' onClick={this.sendRespond} />
                            </div>
                        </div>
                    </div>
                ...
                <Dialog visible={this.state.viewModalSMP} style={{ width: '30vw' }} footer={footerViewModalSMP} modal={true} showHeader={false} closeOnEscape={false} onHide={() => this.setState({ viewModalSMP: false })}>
                    <Card style={{ borderColor: '#2196f3', background: 'linear-gradient(to bottom, #e3f2fd, #f1f8e9)' }}>
                        <div className="ui-grid ui-grid-responsive ui-fluid">
                            <div className="ui-grid-row" style={{ marginRight: '10px', marginTop: '10px', marginBottom: '10px' }}>
                                <div className="ui-grid-col-5" style={{ padding: '4px 10px', fontWeight: 'bold' }}><label htmlFor="year">CANTIDAD SOLICITADA:</label></div>
                            ...
                            <div className="ui-grid-row" style={{ marginRight: '10px', marginTop: '10px', marginBottom: '10px' }}>
                                <div className="ui-grid-col-5" style={{ padding: '4px 10px', fontWeight: 'bold' }}><label htmlFor="year">TIPO MATERIAL:</label></div>
                                <div className="ui-grid-col-3" style={{ padding: '0px 10px' }}>

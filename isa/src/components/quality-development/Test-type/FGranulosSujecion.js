...
var that;
export class SujecionGranulosForm extends Component {
    constructor() {
        super();
        this.state = {
            testGranularidad: [
    ...
    inputDateEditor(props, field) {
        ...
        return <Calendar id={props.rowIndex} dateFormat="yy/mm/dd" value={this.state.testGranularidad[props.rowIndex][field]} locale={es} showTime={true} onChange={(e) => this.onEditorValueChange(props, e.value)} />
    }

...
var that;
export class ReblandecimientoForm extends Component {
    constructor() {
        super();
        this.state = {
    ...
    inputDateEditor(props, field) {
        ...
        return <Calendar id={props.rowIndex} dateFormat="yy/mm/dd" value={this.state.testReblandecimiento[props.rowIndex][field]} locale={es} showTime={true} onChange={(e) => this.onEditorValueChange(props, e.value)} />
    }

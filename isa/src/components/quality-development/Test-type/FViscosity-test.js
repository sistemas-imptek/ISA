...
/* ====================  U T I L S  ======== */
import { formattedDate, formattedDateAndHour, formattedStringtoDate } from '../../../utils/FormatDate';
...
var that;
export class ViscosityForm extends Component {
    constructor() {
        super();
        this.state = {
            testViscosityData: [
    ...
    inputDateEditor(props, field) {
        ...
        return <Calendar id={props.rowIndex} dateFormat="yy/mm/dd" value={this.state.testViscosityData[props.rowIndex][field]} locale={es} showTime={true} onChange={(e) => this.onEditorValueChange(props, e.value)} />
    }

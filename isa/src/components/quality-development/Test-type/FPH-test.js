...
var that;
export class PhForm extends Component {
    constructor() {
        super();
        this.state = {
            testPhData: [
    ...
    inputDateEditor(props, field) {
        ...
        return <Calendar id={props.rowIndex} dateFormat="yy/mm/dd" value={this.state.testPhData[props.rowIndex][field]} locale={es} showTime={true} onChange={(e) => this.onEditorValueChange(props, e.value)} />
    }
            ...
            <div className="ui-g">
                ...
                <div className="ui-g-12">
                    ...
                    <DataTable value={this.state.testPhData} editable={true}>
                        ...
                        <Column field="dateLog" header="Fecha" editor={this.dateEditor} body={this.renderDate} style={{ height: '3.5em' }} />
